	...
	if (objects[LARA].loaded)
	{
		if (!(lara_item->flags & IFL_INVISIBLE))
		{
			...
			if (lara_item->mesh_bits && !SCNoDrawLara)
			{
				...
				{
					aMXPtr[M00] = lara_matricesF[11 * indices_count + M00];
					aMXPtr[M01] = lara_matricesF[11 * indices_count + M01];
					aMXPtr[M02] = lara_matricesF[11 * indices_count + M02];
					aMXPtr[M03] = lara_matricesF[11 * indices_count + M03];
					aMXPtr[M10] = lara_matricesF[11 * indices_count + M10];
					aMXPtr[M11] = lara_matricesF[11 * indices_count + M11];
					aMXPtr[M12] = lara_matricesF[11 * indices_count + M12];
					aMXPtr[M13] = lara_matricesF[11 * indices_count + M13];
					aMXPtr[M20] = lara_matricesF[11 * indices_count + M20];
					aMXPtr[M21] = lara_matricesF[11 * indices_count + M21];
					aMXPtr[M22] = lara_matricesF[11 * indices_count + M22];
					aMXPtr[M23] = lara_matricesF[11 * indices_count + M23];
					SetGunFlash(lara.gun_type);
				}

				if (lara.left_arm.flash_gun)
				{
					aMXPtr[M00] = lara_matricesF[14 * indices_count + M00];
					aMXPtr[M01] = lara_matricesF[14 * indices_count + M01];
					aMXPtr[M02] = lara_matricesF[14 * indices_count + M02];
					aMXPtr[M03] = lara_matricesF[14 * indices_count + M03];
					aMXPtr[M10] = lara_matricesF[14 * indices_count + M10];
					aMXPtr[M11] = lara_matricesF[14 * indices_count + M11];
					aMXPtr[M12] = lara_matricesF[14 * indices_count + M12];
					aMXPtr[M13] = lara_matricesF[14 * indices_count + M13];
					aMXPtr[M20] = lara_matricesF[14 * indices_count + M20];
					aMXPtr[M21] = lara_matricesF[14 * indices_count + M21];
					aMXPtr[M22] = lara_matricesF[14 * indices_count + M22];
					aMXPtr[M23] = lara_matricesF[14 * indices_count + M23];
					SetGunFlash(lara.gun_type);
				}
