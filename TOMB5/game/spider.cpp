...
void inject_spider()
{
	INJECT(0x0047A140, GetFreeSpider);
	INJECT(0x0047A1B0, ClearSpiders);
	INJECT(0x0047A200, TriggerSpider);
	INJECT(0x0047A340, UpdateSpiders);
	INJECT(0x0047A730, DrawSpiders);
}
